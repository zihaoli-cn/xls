...
class AreaEstimator {
 public:
  AreaEstimator(const DelayEstimator* delay_estimator) : delay_estimator_(delay_estimator) {}
...
absl::StatusOr<std::unique_ptr<AreaEstimator>> GetAreaEstimatorByName(absl::string_view name);
